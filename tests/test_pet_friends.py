...
# Мой тест 1
def test_add_new_pet_without_photo_with_valid_data(name='Барс', animal_type='Дворовый кот', age='4'):
...
# Мой тест 2
def test_add_pet_new_photo(pet_photo='images/cat_b.jpeg'):
...
# Мой тест 4
def test_get_api_key_for_invalid_user_email(email='weq', password=valid_password):
...
# Мой тест 5
def test_get_api_key_for_invalid_user_password(email=valid_email, password='123tgb'):
...
# Мой тест 6
def test_add_new_pet_with_negative_age(name='Мурзик', animal_type='Дворовый',
                                       age='-1', pet_photo='images/cat.jpg'):
...
# Мой тест 7
def test_add_new_pet_with_too_old_age(name='Пес', animal_type='доберман',
    ...
    # Сверяем полученный ответ с ожидаемым результатом
    assert status == 200
    print('Баг - сайт позволяет добавить питомца, имеющего слишком большой возраст (более 50 лет)')
